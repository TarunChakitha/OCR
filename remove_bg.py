...
#cv2.imwrite("cropped_stop.jpg",cropped)
...
# median blur
median_blur1 = cv2.medianBlur(gray1,11)
cv2.imshow("median_blur1",median_blur1)

# otsu
ret1, otsu1 = cv2.threshold(median_blur1,40,255,cv2.THRESH_BINARY)
print(ret1)
...
# dilation
dilation1 = cv2.dilate(inverted1,np.ones((5,5),np.uint8),iterations=2)
