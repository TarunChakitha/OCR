...
def getrotated(image):
    ...
    #print("corrected mar angle simple",simpleAngle(median_angles))
    #print("corrected mar angle abc",abc(median_angles))
    ...
    rotated_median_abc = rotate(image,abc(median_angles),(0,0,0))
    ...
    #print("corrected max contour angle abc", abc(max_contour_angle))

    max_contour_rotated_complex = rotate(image,complexAngle(max_contour_angle),(0,0,0))
    max_contour_rotated_simple = rotate(image,simpleAngle(max_contour_angle),(0,0,0))
    max_contour_rotated_abc = rotate(image,abc(max_contour_angle),(0,0,0))
    ...
    #cv2.imwrite("max contour abc.jpg",max_contour_rotated_abc)
    #cv2.imwrite("opening.jpg",opening)
    ...
    return max_contour_rotated_complex